...
function buildPrompt(paper: Paper): string {
  ...
  return [
    ...
    "次の要約から、スマホで左右スワイプする4枚の図解カード用テキストを作ってください。",
    "",
    "トーン: 上品な です・ます調。煽り・誇張は禁止。",
    "各フィールド40〜80字。1カード=1メッセージ。",
    "",
    "・ask: この研究が問いかけたこと",
    "・method: どう調べたか（データ・対象・手法を1つ）",
    "・finding: 何がわかったか（数値や比較があれば1つ）",
    "・meaning: だから私たちにとって何か",
    "",
